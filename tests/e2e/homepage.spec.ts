...
test.describe('Homepage', () => {
  ...
  test('should display main heading and subtitle', async ({ page }) => {
    ...
    // Check for subtitle
    await expect(page.getByText(/your local developer community/i)).toBeVisible();
  });
  ...
  test('should have working navigation links', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: /local meet ups/i })).toBeVisible();
    await expect(page.getByRole('link', { name: /local data resources/i })).toBeVisible();
  ...
  test('should display welcome message', async ({ page }) => {
    ...
    await expect(page.getByText(/This is your one stop for information/i)).toBeVisible();
  });
